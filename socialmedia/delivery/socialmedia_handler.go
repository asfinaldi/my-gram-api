...
import (
	...
	"final-project/socialmedia/delivery/middleware"
	"final-project/socialmedia/utils"
	"net/http"
...
type socialMediaHandler struct {
	socialMediaUseCase models.SocialMediaUseCase
}

func NewSocialMediaHandler(routers *gin.Engine, socialMediaUseCase models.SocialMediaUseCase) {
